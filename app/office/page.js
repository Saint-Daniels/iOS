      ...
      <Container fluid>
        ...
        {activeTab === 'dialer' && (
          <div className="dialer-layout">
            {/* Dialer Pad Section - Moved to top */}
                  ...
                  <div className="dialer-grid">
                    {[
                      ...
                      <Button
                        ...
                        onClick={() => setPhoneNumber(prev => prev + key.num)}
                      >
                  ...
                  <Row className="mb-4">
                    <Col md={4}>
                      <Form.Group className="mb-3">
                        ...
                        <Form.Control type="text" placeholder="Enter first name" className="form-control-lg" />
                      </Form.Group>
          </Col>
                    <Col md={4}>
                      <Form.Group className="mb-3">
                        <Form.Label>Middle Name</Form.Label>
                        <Form.Control type="text" placeholder="Enter middle name" className="form-control-lg" />
                      </Form.Group>
                    </Col>
                    <Col md={4}>
                      <Form.Group className="mb-3">
                        <Form.Label>Last Name</Form.Label>
                        <Form.Control type="text" placeholder="Enter last name" className="form-control-lg" />
                      </Form.Group>
          </Col>
        </Row>
                  ...
                  <Row className="mb-4">
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        ...
                        <Form.Control type="email" placeholder="Enter email" className="form-control-lg" />
                      </Form.Group>
                    </Col>
                  </Row>
